...
export const systemQuestions = [
  ...
  {
    question:
      "Is there something specific that made you think this bill is needed?",
    example:
      "For example: a recent event, a news story, something you saw, etc.",
  },
  {
  ...
  },
  {
    ...
    example:
      "For example: new rules, more money for programs, tax breaks, etc.",
  },
  {
    question: "When do you want the changes to start?",
    example:
      "For example: right away, over time, start with a small test, etc.",
  },
  {
    question:
      "Are there any people or groups you think should help make this bill?",
